...
public class Report {
	 ...
	 * 
	 * @param message
	 *            The information message to be printed.
	 */
	 ...
	 * 
	 * @param location
	 *            Location the information message is related to.
	 * @param message
	 *            The information message to be printed.
	 */
	 ...
	 * 
	 * @param location
	 *            Location the warning message is related to.
	 * @param message
	 ...
	 * An error.
	 * 
	 * Thrown whenever the program reaches a situation where any further
	 * computing makes no sense any more because of the erroneous input.
	 * 
	 * @author sliva
	 *
	 */
	...
	public static class Error extends java.lang.Error {
		...
		/**
		 * Constructs a new error relating to the specified part of the source
		 * file.
		 * 
		 * @param location
		 *            Location the error message is related to.
		 * @param message
		 *            The error message.
		 */
