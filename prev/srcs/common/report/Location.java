...
public class Location implements Locatable, Loggable {
	...
	/**
	 * The line number of the first character of the specified part of the
	 * source file.
	 */
	private final int begLine;

	/**
	 * The column number of the first character of the specified part of the
	 * source file.
	 */
	...
	/**
	 * The column number of the last character of the specified part of the
	 * source file.
	 */
	 ...
	 * 
	 * @param begLine
	 *            The line number of the first character of the specified part
	 *            of the source file.
	 * @param begColumn
	 *            The column number of the first character of the specified part
	 *            of the source file.
	 * @param endLine
	 *            The line number of the last character of the specified part of
	 *            the source file.
	 * @param endColumn
	 *            The column number of the last character of the specified part
	 *            of the source file.
	 */
	 ...
	 * 
	 * @param line
	 *            The line number of the character of the specified part of the
	 *            source file.
	 * @param column
	 *            The column number of the character of the specified part of
	 *            the source file.
	 */
	 ...
	 * 
	 * @param that
	 *            An object relating to a part of a source file.
	 */
	 ...
	 * 
	 * @param beg
	 *            An object relating to the beginning of part of a source file.
	 * @param end
	 *            An object relating to the end of part of a source file.
	 */
